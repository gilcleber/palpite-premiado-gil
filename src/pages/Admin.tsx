      ...
      <div className="bg-white border-b shadow-sm sticky top-0 z-40">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4 flex-1">
            <span className="text-sm font-semibold text-gray-500 uppercase tracking-wider hidden md:inline">Gerenciando Jogo:</span>

            <div className="flex items-center gap-2">
              <select
                className="bg-[#1d244a] text-white px-4 py-2 rounded-lg font-medium outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer text-sm shadow-md transition-all hover:bg-[#2a3459] max-w-[200px] md:max-w-none"
            ...
            {selectedMatchId && (
              <Button
                ...
                title={matches.find(m => m.id === selectedMatchId)?.visible ? "Jogo Visível (Clique para ocultar/arquivar)" : "Jogo Oculto (Clique para ativar)"}
              >
