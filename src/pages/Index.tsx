...
const Index = () => {
  ...
  return (
    <div className="min-h-screen w-full relative overflow-x-hidden safe-area-inset-top safe-area-inset-bottom">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800">
        <div
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none overflow-hidden">
          <img
            src="/radio_logo.png"
            alt="Watermark"
            className="w-[90%] md:w-[70%] lg:w-[50%] opacity-10 mix-blend-overlay grayscale blur-[1px]"
          />
        </div>
      </div>
