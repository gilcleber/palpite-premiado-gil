...
const WinnerDraw = ({ matchId }: { matchId: string | null }) => {
  ...
  const loadMatchSettings = async () => {
    ...
    try {
      ...
      console.error("Error loading match settings:", err);
    }
  };
  ...
  const saveOfficialResult = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Placar de ${teamAName} x ${teamBName} definido como ${scoreTeamA}x${scoreTeamB}`,
      });
    } catch (error) {
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center justify-center space-x-6">
              ...
              <div className="flex flex-col items-center">
                <span className="text-sm font-bold text-[#1d244a] mb-1">{teamAName || "Time A"}</span>
              ...
              <span className="text-xl font-bold text-gray-400 mt-6">X</span>

              {/* Team B */}
              <div className="flex flex-col items-center">
                <span className="text-sm font-bold text-[#1d244a] mb-1">{teamBName || "Time B"}</span>
                <div className="flex items-center">
                  <Button
                    variant="outline" size="sm"
                    className="h-10 w-10 rounded-l-md border-r-0"
