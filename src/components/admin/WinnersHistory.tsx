...
const WinnersHistory = () => {
    ...
    const filteredWinners = winners.filter(w =>
        w.participant?.nome_completo.toLowerCase().includes(searchTerm.toLowerCase()) ||
        w.match?.team_a_name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        w.match?.team_b_name.toLowerCase().includes(searchTerm.toLowerCase())
    );
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                <Button
                                                    variant="outline"
                                                    size="sm"
                                                    onClick={() => handleInstagramSearch(winner.participant.nome_completo, winner.participant.cidade)}
